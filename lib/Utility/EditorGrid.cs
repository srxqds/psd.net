/*
 * File: Assets/Editor/EditorGrid.cs
 * Project: Demo
 * Company: com.luckygz
 * Porter: D.S.Qiu
 * Create Date: 8/2/2015 9:58:15 PM
 */
using UnityEngine;
...
public class EditorGrid
{
    ...
    public static void Draw(Rect rect, Vector2 offset, Type gridType = Type.UnityChecked)
    {
        if (inst == null)
        {
            inst = new EditorGrid();
    ...
    void InitTexture()
    {
        if (gridTexture == null)
        {
            ...
            Type gridType = Type.LightChecked;// tk2dPreferences.inst.gridType;
            switch (gridType)
            {
                ...
                case Type.UnityChecked: c0 = new Color32(71, 71, 71, 255); c1 = new Color32(102, 102, 217, 255); break;
